...
class InsightsPage:
    ...
    def render(data):
        ...
        tab1, tab2, tab3, tab4, tab5 = st.tabs(
            ["AUDIENCE PERSONAS", "MESSAGING", "ANALYTICS", "RECOMMENDATIONS", "EXPORT"]
        )
        ...
        with tab3:
            ...
            with col2:
                ...
                for persona in data["personas"]:
                    ...
                    persona_data.append(
                        {"Persona": persona["name"], "Complexity Score": score}
                    )
        ...
        with tab5:
            ...
            with col1:
                ...
                # Text Report
                report_content = ReportGenerator.generate_report(data)

                # Render download button with the string content
                st.download_button(
                    label="Download Report (TXT)",
                    data=report_content,
                    file_name="taste_target_report.txt",
                    mime="text/plain",
                )
