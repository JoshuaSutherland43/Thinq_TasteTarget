...
from models.schemas import ProductInput, TastePersona, CampaignCopy  # Adjust as needed
from services.openai_service import call_openai_api, extract_json_from_response  # Add helpers here
